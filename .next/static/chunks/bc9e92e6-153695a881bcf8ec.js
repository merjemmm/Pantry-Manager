"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{IO:function(){return i3},JU:function(){return iD},PL:function(){return so},QT:function(){return ss},ad:function(){return iL},hJ:function(){return ib},oe:function(){return su},pl:function(){return sl}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ss(e){e=iI(e,iN);let t=iI(e.firestore,iR);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new iu({next:s=>{t.enqueueAndForget(()=>rM(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rB(new e3(n.path),s,{includeMetadataChanges:!0,oa:!0});return rF(e,a)})(await ip(e),e.asyncQueue,t,n,r)),r.promise})(iV(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sa(e);return new sn(e,i,t._key,r,new st(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sa extends se{constructor(e){super(),this.firestore=e}convertBytes(e){return new iF(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iN(this.firestore,null,t)}}function so(e){e=iI(e,iA);let t=iI(e.firestore,iR),n=iV(t),r=new sa(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
